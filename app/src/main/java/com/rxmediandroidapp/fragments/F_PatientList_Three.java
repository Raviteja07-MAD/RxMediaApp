...
public class F_PatientList_Three extends Fragment {

    ImageView backbtn_img;
    TextView title_txt;

    RecyclerView f_patient_three_recyler;
    ...
    private void initilization(View v) {
       ...
       // customRecyclerview.Assigndatatorecyleviewhashmap( marketing_exicutive_recyler, StoredObjects.dummy_list,"marketing_exicutive", StoredObjects.Listview, 0, StoredObjects.ver_orientation, R.layout.marketing_exicutive_listitem);
        ...
        f_patient_three_recyler.setAdapter(new HashMapRecycleviewadapter(getActivity(),StoredObjects.dummy_list,"f_patient_three",f_patient_three_recyler,R.layout.f_patientlist_three_listitem));
